<form id="contact-form" class="contact-form">
  ...
  <div class="school-section clearfix">
    ...
    <input id="school-name" class="contact-form-field b1 white col-sm-5 col-xs-12" type="text" name="school_name" value="" placeholder="School's name" required>
    <input id="school-email" class="contact-form-field b1 white col-sm-5 col-sm-push-2 col-xs-12"  type="email" name="school_email" value="" placeholder="School's email" required>
    <input id="contact-person" class="contact-form-field b1 white col-sm-5 col-xs-12" type="text" name="contact_person" value="" placeholder="Contact person" required>
    <input id="school-contact-no" class="contact-form-field b1 white col-sm-5 col-sm-push-2 col-xs-12" type="text" name="school_contact_no" value="" placeholder="School's contact no." required>
    <input id="school-address" class="contact-form-field b1 white col-sm-5 col-xs-12" type="text" name="school_address" value="" placeholder="School's address" required>
    <input id="city" class="contact-form-field b1 white col-sm-5 col-sm-push-2 col-xs-12" type="text" name="city" value="" placeholder="City" required>
  ...
  <div class="col-xs-12 form-footer">
    <input class="btn btn-red-invert col-sm-3" type="submit" value="Submit">
  </div>
